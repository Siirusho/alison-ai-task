...
const CollaborativeCounter = ({ counter, onIncrement, onDecrement }: CounterWidgetProps) => {
    ...
    return (
        <div className="h-full flex flex-col bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="flex-grow flex flex-col items-center pt-0 p-6">
                <div
                    className="p-8 mb-8 rounded-xl bg-[#f5deb3] text-white min-w-[120px] text-center shadow-lg"
                >
