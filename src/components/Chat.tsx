                    ...
                    {messages.length === 0 ? (
                        ...
                        <div className="space-y-5">
                            {messages.map(message => {
                                ...
                                const expirationText = TimeHelpers.getExpirationText(message.expiresAt);
                                const isExpired = TimeHelpers.isMessageExpired(message.expiresAt);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`p-4 max-w-[70%] rounded-lg shadow-sm relative ${isOwnMessage
                                        ...
                                        >
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className={`text-xs ${isOwnMessage ? 'opacity-70' : 'text-gray-600'}`}>
                                            ...
                                            <div className="mb-2">
                                                {isExpired ? (
                                                    ...
                                                    <p className={`text-sm leading-relaxed whitespace-pre-wrap break-words ${isOwnMessage ? 'text-white' : 'text-gray-900'}`}>
                                                        {message.content}
                                                    </p>
                                                )}
                                            </div>
                                            ...
                                            {isOwnMessage && !isExpired && (
                                                <button
                                                    ...
                                                    className={`absolute top-2 right-1 opacity-70 hover:opacity-100 p-1.5 rounded ${isOwnMessage ? 'text-white hover:bg-blue-700' : 'text-gray-600 hover:bg-gray-200'
                                                        }`}
                        ...
                        <div className="space-y-4 mt-10">
                            ...
                            <div className="flex gap-3 items-center">
                                <div className="relative flex-shrink-0">
                                    <Clock className="absolute left-35 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none" size={16} />
                                    <input
                                        type="number"
                                ...
                                <button
                                    ...
                                    className={`px-5 py-3 rounded-md transition-colors flex items-center justify-center min-w-[48px] ${messageInput.trim()
